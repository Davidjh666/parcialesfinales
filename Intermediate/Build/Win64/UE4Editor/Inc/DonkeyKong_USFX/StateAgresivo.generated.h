...
#ifdef DONKEYKONG_USFX_StateAgresivo_generated_h
#error "StateAgresivo.generated.h already included, missing '#pragma once' in StateAgresivo.h"
#endif
...
public: \
	DECLARE_CLASS(AStateAgresivo, AActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/DonkeyKong_USFX"), NO_API) \
	DECLARE_SERIALIZER(AStateAgresivo) \
...
#define STATE_DonkeyKong_USFX__master_Source_DonkeyKong_USFX_StateAgresivo_h_13_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, AStateAgresivo); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(AStateAgresivo); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API AStateAgresivo(AStateAgresivo&&); \
	NO_API AStateAgresivo(const AStateAgresivo&); \
public:
